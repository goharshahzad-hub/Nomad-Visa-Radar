...
import { formatVisaFeeForApplicant, VisaCountry } from "@/lib/visa-data";
...
export function CountryCard({
  ...
  return (
    ...
    >
    <Card className="h-full overflow-hidden bg-card/80 transition hover:-translate-y-1 hover:shadow-xl">
      ...
      <div className="p-5">
        ...
        <div className="mt-5 grid grid-cols-2 gap-3 text-sm">
          ...
          <div className="flex items-center gap-2 text-muted-foreground">
            ...
            <span className="truncate" title={formatVisaFeeForApplicant(country, applyingFrom)}>
